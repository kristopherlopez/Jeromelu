...
import pytest
from app.miner.supercoach_teams.fetcher import (
...
def test_live_supercoach_teams_shape():
    ...
    try:
        ...
        pytest.fail(
            ...
            f"app.miner.supercoach_teams.models, regenerate the fixture under "
            f"tests/fixtures/miner/supercoach_teams/canonical_response.json, "
