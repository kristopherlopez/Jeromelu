...
import pytest
from app.miner.nrlcom_stats.fetcher import (
...
def test_live_nrlcom_stats_shape():
    ...
    try:
        ...
        pytest.fail(
            ...
            f"app.miner.nrlcom_stats.models, regenerate the fixture under "
            f"tests/fixtures/miner/nrlcom_stats/canonical_response.json, "
