...
import pytest
from app.miner.nrlcom_players_roster.fetcher import (
    NrlcomPlayersFetchError,
    fetch_players_roster,
)
from app.miner.nrlcom_players_roster.models import NrlcomPlayersRoster
...
def test_live_nrlcom_players_roster_shape():
    ...
    try:
        ...
        pytest.fail(
            ...
            f"app.miner.nrlcom_players_roster.models, regenerate the fixture under "
            f"tests/fixtures/miner/nrlcom_players_roster/canonical_response.json, "
