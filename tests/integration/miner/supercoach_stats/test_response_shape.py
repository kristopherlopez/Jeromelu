...
Env-flagged (`MINER_DRIFT_LIVE=1`). Fetches a small page from the real
...
import pytest
from app.miner.supercoach_stats.fetcher import (
...
def test_live_supercoach_stats_shape():
    ...
    try:
        ...
        pytest.fail(
            ...
            f"(app.miner.supercoach_stats.models), regenerate the fixture, "
