...
[← Data Catalogue](README.md) · [Lineage](../data-lineage/miner_presenter_candidates.md) · Layer 3 — Content & claims

Presenter Miner's staging inbox. Distinct from [miner_candidates](miner_candidates.md) (which discovers *channels* and *videos*) — this one discovers *people who present* a known channel. The Presenter Miner agent files findings here; humans confirm/reject in the admin "Presenters" tab. Confirmation creates (or links to) a [people](people.md) row and writes a [source_presenters](source_presenters.md) association. See migration 052 and [docs/agents/system/presenter-miner.md](../../agents/system/presenter-miner.md).
...
| run_id | text | yes | | Groups all candidates from one Presenter Miner run |
