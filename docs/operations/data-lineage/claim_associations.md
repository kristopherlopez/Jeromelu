...
`upload-transcript` skill — for each [claims](claims.md) row, resolves the subject (and any contextual entities) to typed FKs and writes one association row per typed reference.
