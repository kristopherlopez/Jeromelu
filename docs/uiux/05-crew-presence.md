...
Only show active crew members + Jeromelu. Dormant members collapse into a "+3" overflow showing stacked, tiny, greyed-out avatar faces. Tap to expand.

```
[👤 Scout — Scanning...]   [👤 Jeromelu — Reviewing]   [👤👤👤 +4]
```
...
All crew avatars are desaturated and static except Jeromelu. His avatar plays a slow idle loop — thinking at his desk, occasionally glancing at camera, reviewing something on a screen. Status: "Squad locked. Watching the market."

Jeromelu is never fully dormant. His avatar is always animated. This maintains the "someone's home" feeling. The audience sees a character, not a status string.
...
| Jeromelu | The Call | The front man. Confident posture. Leans toward camera. Orange accent in his visual design. | Cocky, self-aware. The star of the show. |
...
| Remark card (Jeromelu) | 48px circle | Idle animation loop |
...
**Jeromelu gets an expanded library (~15-20 clips):**
...
Only Jeromelu gets the orange accent. The crew supports; Jeromelu stars. This visual hierarchy reinforces who the front man is.
...
Jeromelu's cards are visually distinct from crew cards:
- **Crew cards**: Compact. Zinc left border. Standard text weight. Supporting content.
- **Jeromelu's cards (Remarks)**: Large. Orange left border. Bold voice text. Hero content.

The visual weight tells the audience instantly: crew card = process, Jeromelu card = the call.

---

## Crew Personality in Copy

Each crew member has a voice, but it's expressed through brief, functional copy — not long paragraphs. The personality comes through in word choice and framing.

### Scout

Factual, efficient. Reports what's out there without opinion.

- "4 new episodes overnight. 2 mention Cleary."
- "KingOfSC just dropped a Round 7 preview."
- "Nothing new since last sweep. The ecosystem is quiet."
- "Unusual: 3 sources covering the same trade. Flagging."

### Analyst

Precise, measured. Presents both sides. Highlights tension.

- "Cross-referencing complete: 2 bullish, 1 bearish. The bearish case cites bye schedule."
- "Consensus shift: market turned bearish on Cleary since Tuesday."
- "Contradiction: KingOfSC and NRLBrothers cite the same data, opposite conclusions."
- "Evidence is thin. Only 1 source, low confidence."

### Critic

Sceptical, direct. Pokes holes. Challenges before the call.

- "Two of your three sources are below 50% accuracy this season."
- "Last time you overrode me on a sell call, you lost 40 points."
- "The numbers support this. I have no objection." (rare — and notable when it happens)
- "You're ignoring the Bookkeeper's breakeven analysis. Again."

### Bookkeeper

Numbers-focused. No narrative. Just the math.
...
Historical. Pattern-matching. The long memory.
...
Confident, dry, opinionated. The character defined in [02-character-architecture.md](../../architecture/02-character-architecture.md).
...
When the Critic challenges Jeromelu, the Stream shows a **face-off layout** — two characters visually confronting each other.
...
- Critic's avatar on the left, Jeromelu's on the right. Both at ~48px.
- Critic's text on the left side, Jeromelu's response on the right.
- A "vs" divider between them — subtle but clear.
- The Critic's expression is sceptical (arms crossed, raised eyebrow). Jeromelu's is unflinching (direct eye contact, slight lean forward).

### Video Version

For the most important confrontations, a short video clip (5-8 seconds) plays inline before the text face-off:
- Split screen: Critic on the left, Jeromelu on the right
- Critic shakes head, crosses arms
- Jeromelu dismisses with a hand wave or leans in defiantly
...
```
[👤 Critic, arms crossed] Critic activated · Reviewing Jeromelu's proposed calls
```
