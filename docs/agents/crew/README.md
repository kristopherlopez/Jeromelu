...
| [Miner](miner/README.md) | Reasoning mode + system worker | Research and intelligence gathering | "I've been digging through the pods this week..." (in Jaromelu's voice) |
...
| [Bookkeeper](bookkeeper/README.md) | Reasoning mode + derivation layer | Math, breakevens, derived metrics over Miner-fetched data | "Breakeven's 42 — needs 55+ to pay off..." (in Jaromelu's voice) |
