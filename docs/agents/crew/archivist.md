...
This is the mechanism behind *"Archivist linked this Remark to Jaromelu's earlier call from Round 3"* in [03-the-show.draft.md](../../architecture/drafts/03-the-show.draft.md).
...
- [The Show (draft)](../../architecture/drafts/03-the-show.draft.md) — customer-facing framing of the crew
