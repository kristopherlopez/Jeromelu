...
- On mobile: only show active crew members + Jaromelu. Dormant members collapse into a "+3" overflow indicator showing stacked greyed-out avatars. Tap to expand.
- The bar is ~48px tall — enough for small circular portraits (~32px diameter).
- When all crew are dormant: Jaromelu's avatar plays a slow idle loop (thinking, glancing at camera, occasionally checking something). His status text: "Squad locked. Watching the market."
- Jaromelu is never fully dormant. His avatar is always animated, even if subtly. This maintains the "someone's home" feeling.
...
**2. Remark Cards**
Large, prominent. The hero content. Always attributed to Jaromelu. A Remark is a **performance**, not a card. See [02-remarks.md](02-remarks.md) for full spec.
...
- **Jaromelu's avatar** appears at full size (~48px) alongside the Remark.
- **Entry animation**: Jaromelu's avatar slides in from the left. The voice text types out with a fast typewriter effect (not character by character — phrase by phrase, fast enough to feel punchy, not tedious). Tags fade in after. The card announces itself.
- **High conviction Remarks**: A short **video clip** (3-5 seconds) of Jaromelu delivering the call plays inline above the card — leaning in, confident, looking at camera. This is the "he's actually here" moment.
...
**3. Dialogue Cards**
Audience interactions: questions asked, Jaromelu's responses, Critic challenges.
...
- Jaromelu's avatar appears alongside his response — he's *there*, talking to you.
- **Typing indicator**: While generating a response, Jaromelu's avatar plays a "thinking" animation — rubbing chin, looking up, slight frown of concentration. Not three bouncing dots. A character thinking.
- Jaromelu's responses always have the orange left border.
...
- **Jaromelu's avatar** in the Crew Bar plays a slow idle loop — thinking, reviewing something, occasionally glancing at camera. He's always home.
...
- **Rapid scrolling**: Jaromelu's avatar in the Crew Bar glances down, tracking the scroll direction. A micro-reaction.
- **Hovering over a Remark**: Jaromelu's avatar subtly leans forward — he's watching you engage with his call.
- **Long idle on the page** (2+ minutes without interaction): Jaromelu's avatar yawns, then glances at camera. The status text changes to "Still here? I respect the commitment."
...
- **New Remark notification**: A distinctive short sound. Users learn: "That sound means Jaromelu just made a call."
