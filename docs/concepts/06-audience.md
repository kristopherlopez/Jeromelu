...
- Jaromelu can reference the crowd: "68% of you disagreed. Receipts."
...
The audience can challenge Jaromelu's calls directly. This happens through the Interaction Bar.
...
These appear as Dialogue Cards in the Stream, not attached to any Remark. Jaromelu responds in character, referencing crew intel and existing Remarks where relevant.

---

## Squad Submission

Users can submit their own SuperCoach squad for Jaromelu to review.
...
3. Jaromelu reviews and responds in character:
...
**In the Ledger drill-down** — "You vs Jaromelu" section:
...
- Jaromelu's voice text (the headline)
...
- "Jaromelu is calling SELL on Cleary this week. Do you agree?"
...
When Jaromelu is right and the crowd disagreed:
- A Stream card from Jaromelu: "68% of you disagreed with the Cleary sell. The 32% who backed me — respect."
- This appears during The Reckoning beat.

### Collective Miss

When the crowd and Jaromelu both got it wrong:
- "82% of you agreed with me on Munster. We all ate it together. Respect for going down as a group."

### Contrarian Crowd

When a small minority of the crowd was right against both Jaromelu and the majority:
...
- "The crowd has been more accurate than Jaromelu on captain picks this month. 71% vs 60%."
- "When the crowd disagrees with Jaromelu, Jaromelu has been right 65% of the time this season."

These moments make the audience feel like their participation matters. They come back to see how their record is tracking — and to see if Jaromelu calls them out.

### Crowd Moment Video Clips

The most impactful crowd callouts get video treatment:
- **Vindication**: A short clip of Jaromelu pointing at camera — "Receipts." Then the crowd stat card.
- **Collective miss**: Jaromelu shaking his head, then looking at camera with a "we're in this together" expression.
- **Contrarian crowd was right**: Jaromelu slow-clapping. Genuine respect.
...
- **Scroll to the very top** (oldest content in the Stream): Jaromelu's Crew Bar avatar glances up. Status text: "Going through the archives? Respect. Most people just look at the latest call."
- **Rapid scrolling up and down**: After 3+ fast direction changes, status text: "Make up your mind."
- **Sitting at the bottom of the Stream for 30+ seconds without scrolling**: Jaromelu's avatar gives a subtle nod — acknowledgment that you're watching live.

### Interaction Quirks

- **Submit an empty question** (hit send with no text): Jaromelu responds inline: "I can't read minds. Yet."
- **Ask "who are you?"**: A special response with more personality than usual — not a product description, but Jaromelu introducing himself in character.
...
- **User agrees with Jaromelu 5+ times in a row**: Status text: "You're catching on." Jaromelu's avatar gives a brief approving nod.
- **User disagrees with Jaromelu 5+ times in a row**: "Contrarian. I can respect that." Slight smirk.
- **User's accuracy exceeds Jaromelu's over 10+ Remarks**: "You might be better at this than me. Don't let it go to your head." (Only shown once per season.)

### The 404 Page

If someone hits a broken link: Jaromelu's avatar with a confused expression. "This page doesn't exist. Even I make mistakes. But not this one — you typed the URL wrong."

### Long-Term Engagement

- **100th visit**: A subtle Stream card from the Archivist: "You've been here 100 times this season. That's dedication. Jaromelu appreciates the audience."
- **User who has reacted to every Remark in a round**: "You didn't miss a single call this round. That's commitment." Brief Jaromelu avatar thumbs-up.
