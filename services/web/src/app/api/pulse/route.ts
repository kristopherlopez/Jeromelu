...
const CREW: PulseResponse["crew"] = [
  { id: "scout", name: "Scout", role: "finds new sources", color: "var(--accent)", icon: "search", schedule: "Every 4h" },
  { id: "scribe", name: "Scribe", role: "transcribes audio/video", color: "var(--terracotta)", icon: "pen", schedule: "When Scout finds new" },
...
const TIMELINE: PulseResponse["timeline"] = [
  // ~6h ago — Scout's overnight run
  { t: -370, agent: "scout", kind: "discovered", source: { type: "video", title: "Tigers vs Panthers — Full Match Replay", host: "NRL on Nine", url: "youtube.com/...", duration: "1:42:18" }, note: "Friday's full game just dropped." },
  { t: -368, agent: "scout", kind: "discovered", source: { type: "podcast", title: "Sin Bin Ep. 412 — Round 7 Reset", host: "Andrew Johns + Brandy", duration: "58:12" }, note: "Joey & Brandy talking halves." },
  { t: -365, agent: "scout", kind: "discovered", source: { type: "article", title: "Luai's quiet brilliance papers over Tigers cracks", host: "Wide World of Sports" }, note: "Long read on Tigers' midfield." },
  ...
  { t: -220, agent: "scout", kind: "discovered", source: { type: "article", title: "Bunnies sweat on Walker fitness", host: "Sydney Morning Herald" }, note: "Grade 1 calf — game-day call." },
  {
  ...
  // ~30m ago
  { t: -28, agent: "scout", kind: "discovered", source: { type: "video", title: "Tedesco try clip — Roosters trial", host: "Fox League" }, note: "Worth a look. Looks fit." },
  { t: -22, agent: "scout", kind: "discovered", source: { type: "tweet", title: "Storm name 18-man squad", host: "@storm" }, note: "Hughes named, Munster benched? Cap call." },

  // Now — running
  { t: -2, agent: "scout", kind: "running", source: { type: "feed", title: "Scanning Reddit r/nrl" }, note: "Looking for late mail." },
  ...
  { t: 60, agent: "scout", kind: "queued", source: { type: "schedule", title: "Next sweep" }, note: "Round 7 team list deadline." },
