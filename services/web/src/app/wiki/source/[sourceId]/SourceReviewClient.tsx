        ...
        <div className="w-full lg:w-[50%] p-4 lg:p-6 lg:pl-0 lg:overflow-hidden flex flex-col">
          ...
          <div className="flex gap-4 border-b mb-0" style={{ borderColor: "var(--border)" }}>
            ...
            <button
              ...
              className="pb-2 text-[11px] font-semibold uppercase tracking-wider transition-colors"
              style={{
                color: activeTab === "voices" ? "var(--accent)" : "var(--foreground-muted)",
                borderBottom: activeTab === "voices" ? "2px solid var(--accent)" : "2px solid transparent",
              }}
            >
              Voices
            </button>
          ...
          <div className="flex-1 min-h-0 overflow-hidden mt-4">
            {isAwaitingTranscript ? (
              ...
              <VoicesPanel
                ...
                onSeek={handleSeek}
                onClusterAssigned={() => {
                  // Voice cluster assign only writes DB columns the
                  // overlay also reads (speaker_person_id, match_method),
                  // so refresh the speakers list. Face-track JSON isn't
                  // regenerated by this flow — face boxes stay where they
