...
`tests/fixtures/scout/nrlcom_players_roster/canonical_response.json`
...
**Note on the existing README example.** `services/api/app/scout/nrlcom_players_roster/README.md`
