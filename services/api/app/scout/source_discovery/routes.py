...
@router.post(
    "/admin/scout/source-discovery/youtube",
...
def deterministic_youtube_discovery_endpoint(
    ...
    candidates to ``scout_candidates``. It does not schedule itself; cron can
    call this route later with the same X-Admin-Key pattern as other Scout
