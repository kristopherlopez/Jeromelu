"""Miner/SuperCoach stats admin endpoint with the standard agent_audit wrapper.

POST /api/admin/miner/supercoach-stats?round=N&season=Y
  ...
  - Writes an agent_runs row under agent_id='miner',
    ...
    *,
    ...
    try:
        ...
        if archive_only:
            ...
            logger.info(
                "miner/supercoach-stats: archive_only=true; strict-parse + upsert "
...
def supercoach_stats_endpoint(
    ...
    under `agent_id='miner'`, `detail_json.pipeline='supercoach-stats'`.
    """
