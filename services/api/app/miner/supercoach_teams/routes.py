"""Miner/SuperCoach teams admin endpoint with agent_audit + S3-first capture."""
...
def run_supercoach_teams(
    ...
    *,
    ...
    try:
        ...
        logger.info(
            "miner/supercoach-teams: fetched %d teams (season=%s, run_id=%s)",
            fetched,
            effective_season,
            run.run_id,
        )
