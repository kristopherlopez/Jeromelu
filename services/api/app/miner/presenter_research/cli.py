...
python -m app.miner.presenter_research.cli --channel-id <uuid>
python -m app.miner.presenter_research.cli --source-id <uuid>          # resolves to channel
python -m app.miner.presenter_research.cli --channel-id <uuid> --dry-run
python -m app.miner.presenter_research.cli --channel-id <uuid> --model claude-opus-4-7
"""
