...
python -m app.miner.source_discovery.cli                       # default brief, sonnet 4.6
python -m app.miner.source_discovery.cli --dry-run             # don't persist; just print
python -m app.miner.source_discovery.cli --model claude-opus-4-7
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--dry-run",
        action="store_true",
        help="Run the agent and print everything but do NOT write to miner_candidates",
    )
