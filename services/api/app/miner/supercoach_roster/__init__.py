"""Miner pipeline: SuperCoach player roster acquisition.
...
Folder layout follows D9 of the Miner charter expansion: each pipeline
gets its own folder under services/api/app/miner/<pipeline_name>/.
