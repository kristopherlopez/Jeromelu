"""Bounded drain helpers for Miner media and Analyst hand-off queues."""
...
def pending_audio_source_criteria() -> tuple[object, ...]:
    """Eligibility criteria for Miner audio acquisition."""
    return (
...
def select_pending_audio_source_ids(session: Session, *, limit: int) -> list[UUID]:
    """Select approved YouTube sources still waiting for Miner audio."""
