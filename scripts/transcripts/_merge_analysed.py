...
type_map = {
    ...
    "sell_consideration": "sell",
    "hold_recommendation": "hold",
    "avoid_recommendation": "avoid",
    "do_not_buy": "avoid",
    "not_a_target": "avoid",
    "captaincy": "captain",
    "watchlist": "hold",
    ...
    "role_concern": "hold",
    "role_change": "hold",
    "role_confirmation": "hold",
    "minutes_risk": "hold",
    "start_recommendation": "buy",
}
...
with open(f"data/transcripts/clean/{FN}.json", encoding="utf-8") as f:
...
# 7. Write topics.json
with open(f"{BASE}/{FN}.chapters.json", encoding="utf-8") as f:
...
for ch in chapters:
    ce = {
        ...
        "end_ts": ch["end_ts"],
        "start_seg_idx": ch["start_seg_idx"],
        "end_seg_idx": ch["end_seg_idx"],
        "segment_count": ch["end_seg_idx"] - ch["start_seg_idx"] + 1,
        "teams": ch.get("teams", []),
        "context_hint": ch.get("context_hint", ""),
        "sub_topics": [],
    }
...
manifest = {
    ...
    "phase2": {
        ...
        "chapter_types": dict(Counter(ch["type"] for ch in chapters)),
    },
    "chapters": chapters,
    "phase3": {
        "model": "opus",
